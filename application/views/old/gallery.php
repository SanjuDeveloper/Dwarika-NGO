        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="gallery-block col-lg-4 col-md-6 col-sm-12 wow fadeIn">
                    <div class="image-box">
                        <figure class="image"><a href="images/gallery/1.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/gallery/1.jpg" alt=""></a></figure>
                    </div>
                </div>
                ...
                <div class="gallery-block col-lg-4 col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                    <div class="image-box">
                        <figure class="image"><a href="images/gallery/2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/gallery/2.jpg" alt=""></a></figure>
                    </div>
                </div>
                ...
                <div class="gallery-block col-lg-4 col-md-6 col-sm-12 wow fadeIn" data-wow-delay="800ms">
                    <div class="image-box">
                        <figure class="image"><a href="images/gallery/3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/gallery/3.jpg" alt=""></a></figure>
                    </div>
                </div>
